...
const menu = [
  {
    ...
    dropdown: [
      {
        label: "CRM",
        desc: "Manage leads and customers",
        to: "/features",
        Icon: Users,
      },
      {
        label: "HRMS",
        desc: "People, payroll and attendance",
        to: "/features",
        Icon: UserCheck,
      },
      {
        label: "ERP",
        desc: "Run operations end to end",
        to: "/features",
        Icon: Boxes,
      },
      {
        label: "CMS",
        desc: "Build and manage content",
        to: "/features",
        Icon: FileCode,
      },
    ],
  ...
  { label: "Pricing", to: "/pricing" },
  {
    ...
    dropdown: [
      ...
      },
      {
        ...
        desc: "Latest releases and changes",
        to: "/features",
        Icon: Rocket,
      },
    ],
  },
  {
    ...
    dropdown: [
      {
        label: "Case Studies",
        desc: "Real results from real teams",
        to: "/#case-studies",
        Icon: FileText,
      },
      {
        label: "Blogs",
        desc: "Insights, tips and updates",
        to: "/about",
        Icon: Newspaper,
      },
      {
              ...
              item.dropdown ? (
                ...
                >
                  <button className="navbar__link navbar__link--drop">
                    ...
                    <ChevronDown
                      size={15}
                      className={`navbar__chev ${activeDrop === item.label ? "rot" : ""}`}
                    />
                  </button>
                    ...
                    {activeDrop === item.label && (
                      ...
                      >
                        {item.dropdown.map((d) => (
                          ...
                          >
                            <span className="navbar__drop-ico">
                              <d.Icon size={18} />
                            </span>
        ...
        <AnimatePresence>
          {open && (
            ...
            >
                ...
                item.dropdown ? (
                  <div key={item.label} className="navbar__drawer-group">
                    <button
                      ...
                      onClick={() =>
                        setMobileDrop(
                          mobileDrop === item.label ? null : item.label,
                        )
                      }
                    >
                      {item.label}
                      <ChevronDown
                        size={16}
                        className={mobileDrop === item.label ? "rot" : ""}
                      />
                    </button>
              ...
              <Link
                to="/contact"
                className="btn btn-secondary navbar__drawer-cta"
              >
                14 Day Free Trial
              </Link>
              <Link
