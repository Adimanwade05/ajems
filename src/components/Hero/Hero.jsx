...
export default function Hero() {
  ...
  // Drive the cinematic scaling from the sticky stage's scroll progress.
  ...
  return (
    <section className="hero">
      {/* Plain gradient bg + single top-left svg */}
      <div className="hero__gradient" />
      <TrafficGrid />
      <img src={cornerImg} className="hero__corner" alt="" aria-hidden="true" />
      <img src={cornerImg} className="hero__corner hero__corner--right" alt="" aria-hidden="true" />
      ...
      <div className="container hero__content">
        {/* <motion.span
          ...
          custom={0}
        >
          <span className="hero__dot" /> One intelligent platform
        </motion.span> */}
        ...
        <motion.p
          ...
          custom={2}
        >
          Design forms, automate workflows, track performance, and scale operations without coding.
